...
var require_parse = __commonJS({
  "node_modules/picomatch/lib/parse.js"(exports, module) {
    ...
    var parse = (input, options) => {
      ...
      const PLATFORM_CHARS = constants.globChars(opts2.windows);
      ...
      const extglobClose = (token) => {
        ...
        if ((token.type === "plus" || token.type === "star") && analysis.risky) {
          const safeOutput = analysis.safeOutput ? (token.output ? "" : ONE_CHAR) + (opts2.capture ? `(${analysis.safeOutput})` : analysis.safeOutput) : void 0;
      ...
      while (state.brackets > 0) {
        if (opts2.strictBrackets === true) throw new SyntaxError(syntaxError("closing", "]"));
    ...
    parse.fastpaths = (input, options) => {
      ...
      const {
        ...
        STAR,
        START_ANCHOR
      } = constants.globChars(opts2.windows);
      ...
      const globstar = (opts3) => {
        if (opts3.noglobstar === true) return star;
        return `(${capture}(?:(?!${START_ANCHOR}${opts3.dot ? DOTS_SLASH : DOT_LITERAL}).)*?)`;
      };
      const create = (str) => {
        switch (str) {
  ...
  "node_modules/picomatch/lib/picomatch.js"(exports, module) {
    ...
    var picomatch2 = (glob, options, returnState = false) => {
      ...
      if (opts2.ignore) {
        ...
        isIgnored = picomatch2(opts2.ignore, ignoreOpts, returnState);
      }
...
// node_modules/@astrojs/preact/dist/server.js
...
function A(e, t) {
  return { __v: e, context: t, props: e.props, setState: C2, forceUpdate: C2, __d: true, __h: new Array(0) };
}
function S2(e, t, n) {
  if (!e.s) {
    if (n instanceof L) {
      if (!n.s) return void (n.o = S2.bind(null, e, t));
      1 & t && (t = n.s), n = n.v;
    }
    if (n && n.then) return void n.then(S2.bind(null, e, t), S2.bind(null, e, 2));
    e.s = t, e.v = n;
    const r2 = e.o;
    r2 && r2(e);
  }
...
var L = (function() {
  ...
  return e.prototype.then = function(t, n) {
    ...
    return this.o = function(e2) {
      try {
        var o3 = e2.v;
        1 & e2.s ? S2(r2, 1, t ? t(o3) : o3) : n ? S2(r2, 1, n(o3)) : S2(r2, 2, o3);
      } catch (e3) {
        S2(r2, 2, e3);
      }
    }, r2;
...
function j(e, t, n) {
  ...
  var c2 = new L(), u2 = S2.bind(null, c2, 2);
  return (0 === r2 ? o2.then(l3) : 1 === r2 ? i2.then(s2) : a2.then(f2)).then(void 0, u2), c2;
  function s2(r3) {
    i2 = r3;
    do {
      if (t && (a2 = t()) && a2.then && !E(a2)) return void a2.then(f2).then(void 0, u2);
      if (!(o2 = e()) || E(o2) && !o2.v) return void S2(c2, 1, i2);
      if (o2.then) return void o2.then(l3).then(void 0, u2);
      E(i2 = n()) && (i2 = i2.v);
    } while (!i2 || !i2.then);
    i2.then(s2).then(void 0, u2);
  }
  function l3(e2) {
    e2 ? (i2 = n()) && i2.then ? i2.then(s2).then(void 0, u2) : s2(i2) : S2(c2, 1, i2);
  }
  function f2() {
    (o2 = e()) ? o2.then ? o2.then(l3).then(void 0, u2) : l3(o2) : S2(c2, 1, i2);
  }
}
function T(e, t) {
  try {
...
var $;
var U;
var Z = function(a2, u2) {
  try {
    var s2 = l[i];
    l[i] = true, D = l.__b, P = l[r], $ = l.__r, U = l.unmount;
    var l3 = k(S, null);
    return l3[c] = [a2], Promise.resolve(T(function() {
      return Promise.resolve(O(a2, u2 || F, false, void 0, l3, true, void 0)).then(function(e) {
        var t, n = (function() {
          if (W(e)) {
            var n2 = function() {
              var e2 = o2.join(H);
      ...
      if (l[o] && l[o](a2, M), l[i] = s2, M.length = 0, t) throw n;
      return n;
    }));
  } catch (e) {
...
function O(t, r2, o2, i2, u2, _2, b2) {
  ...
  if (W(t)) {
    var k3, C3 = H;
    u2[c] = t;
    for (var S3 = t.length, L2 = 0; L2 < S3; L2++) {
      var E2 = t[L2];
      if (null != E2 && "boolean" != typeof E2) {
        var j2, T2 = O(E2, r2, o2, i2, u2, _2, b2);
        "string" == typeof T2 ? C3 += T2 : (k3 || (k3 = new Array(S3)), C3 && k3.push(C3), C3 = H, W(T2) ? (j2 = k3).push.apply(j2, T2) : k3.push(T2));
      }
    }
  ...
  if ("function" == typeof Z2) {
    ...
    if (Z2 === S) {
      if ("tpl" in M2) {
        for (var Q = H, X = 0; X < M2.tpl.length; X++) if (Q += M2.tpl[X], M2.exprs && X < M2.exprs.length) {
          var Y = M2.exprs[X];
          if (null == Y) continue;
          "object" != typeof Y || void 0 !== Y.constructor && !W(Y) ? Q += Y : Q += O(Y, r2, o2, i2, t, _2, b2);
        }
        return Q;
      }
      ...
      I(t, J), K = t[a];
        ...
        for (var ne = 0; y(K) && ne++ < 25; ) {
          ...
          try {
            ...
            throw _2 && e && "function" == typeof e.then && (t._suspended = true), e;
          }
        }
        v(K);
      }
      if (null != K.getChildContext && (r2 = z({}, r2, K.getChildContext())), te && l.errorBoundaries && (Z2.getDerivedStateFromError || K.componentDidCatch)) {
        V = null != V && V.type === S && null == V.key && null == V.props.tpl ? V.props.children : V;
        try {
          return O(V, r2, o2, i2, t, _2, false);
        } catch (e) {
          return Z2.getDerivedStateFromError && (K[s] = Z2.getDerivedStateFromError(e)), K.componentDidCatch && K.componentDidCatch(e, F), y(K) ? (V = I(t, r2), null != (K = t[a]).getChildContext && (r2 = z({}, r2, K.getChildContext())), O(V = null != V && V.type === S && null == V.key && null == V.props.tpl ? V.props.children : V, r2, o2, i2, t, _2, b2)) : H;
        } finally {
          P && P(t), U && U(t);
        }
      }
    ...
    try {
      ...
      if (!_2 && b2 && b2.onError) {
        var oe = (function e(n2) {
          return b2.onError(n2, t, function(t2, n3) {
            try {
              return O(t2, r2, o2, i2, n3, _2, b2);
            } catch (t3) {
              return e(t3);
            }
          });
  ...
  if (ue || ("string" == typeof ae ? ue = g(ae) : null != ae && false !== ae && true !== ae && (ue = O(ae, r2, "svg" === Z2 || "foreignObject" !== Z2 && o2, i2, t, _2, b2))), P && P(t), U && U(t), !ue && R.has(Z2)) return ce + "/>";
  var fe = "</" + Z2 + ">", pe = ce + ">";
...
// node_modules/@astrojs/preact/dist/context.js
...
// node_modules/@astrojs/preact/dist/signals.js
      ...
      values.forEach((valueKey, valueIndex) => {
        ...
        if (isSignal(signal)) {
          ...
          props[key] = isPropObject ? Object.assign({}, props[key], { [keyOrIndex]: signal.peek() }) : props[key].map(
            (v2, i2) => i2 === valueIndex ? [signal.peek(), i2] : v2
          );
...
var filter = opts?.include || opts?.exclude ? createFilter(opts.include, opts.exclude) : null;
async function check(Component, props, children, metadata) {
  ...
  if (Component.prototype != null && typeof Component.prototype.render === "function") {
    return C.isPrototypeOf(Component);
  }
  useConsoleFilter();
  try {
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
  ...
  for (const [key, value] of Object.entries(slotted)) {
    ...
    slots[name] = k(static_html_default, {
  ...
  const vNode = k(
    Component,
    newProps,
    children != null ? k(static_html_default, {
      hydrate: shouldHydrate(metadata),
      value: children
    }) : children
  );
...
//# sourceMappingURL=@astrojs_preact_server__js.js.map
