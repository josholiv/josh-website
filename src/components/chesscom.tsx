...
<p style={{ textIndent: "2rem" }}>
  ...
  ♟️{stats.chess_blitz?.last?.rating}
  </strong>
  {" "}in <a href="https://www.chess.com/terms/blitz-chess" target="_blank" rel="noopener noreferrer">blitz chess</a>
  <br />
  <i style={{ display: "block", textIndent: "2rem" }}>Only <strong style={{ color: "#9b4dca" }}>{getEloDifference("chess_blitz")}</strong> behind{" "}
    <a href="https://www.chess.com/member/magnuscarlsen" target="_blank" rel="noopener noreferrer">
      GM Magnus Carlsen
    </a>!</i>
</p>
...
<p style={{ textIndent: "2rem" }}>
  ...
  ♟️{stats.chess_rapid?.last?.rating}
  </strong>
  {" "}in <a href="https://www.chess.com/terms/rapid-chess" target="_blank" rel="noopener noreferrer">rapid chess</a>
  <br />
  <i style={{ display: "block", textIndent: "2rem" }}>Only <strong style={{ color: "#5c6bc0" }}>{getEloDifference("chess_rapid")}</strong> behind{" "}
    <a href="https://www.chess.com/member/magnuscarlsen" target="_blank" rel="noopener noreferrer">
      GM Magnus Carlsen
    </a>!</i>
</p>
